...
gulp.task('browser-sync', function() {
	browserSync({
		...
		// tunnel: true, tunnel: "cubeproject", // Demonstration page: http://cubeproject.localtunnel.me
	})
});
...
gulp.task('js', function() {
	return gulp.src([
		...
		'app/libs/myPreloader/script.preloader.js',
